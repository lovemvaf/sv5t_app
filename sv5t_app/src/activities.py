...
EVIDENCE_GUIDE: Dict[str, List[Evidence]] = {
    "dao_duc": [
        ...
        Evidence("dao_duc", "Tiêu chí bổ sung", "Đội thi Mác–Lênin/HCM hoặc 'người tốt việc tốt' (huyện/tỉnh+)."),
    ],
    "hoc_tap": [
        Evidence("hoc_tap", "GPA", "ĐH/HV: ≥3.4/4 hoặc ≥8.5/10; CĐ: ≥3.2/4 hoặc ≥8.0/10."),
        Evidence("hoc_tap", "Tiêu chí học thuật", "Chỉ cần 1: NCKH loại tốt / bài báo / kỷ yếu / giải sáng tạo / đội tuyển…"),
    ],
    "the_luc": [
        Evidence("the_luc", "SV Khỏe / Giải thể thao", "Đạt 'Sinh viên khỏe' (từ tỉnh) hoặc giải phong trào cấp trường+."),
    ],
    "tinh_nguyen": [
    ...
    "hoi_nhap": [
        ...
        Evidence("hoi_nhap", "Tiêu chí bổ sung", "Giao lưu quốc tế hoặc đạt giải thi hội nhập/thi học thuật bằng ngoại ngữ."),
    ],
}
